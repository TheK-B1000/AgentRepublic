...
export function Hero() {
  return (
    <Section className="relative pt-20 pb-12 sm:pt-24 sm:pb-16 lg:pt-28 lg:pb-20">
      {/* Background glow blobs (visual only, never block clicks) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] gap-10 lg:gap-14 items-center">
          ...
          <div className="w-full max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-sky-300/30 bg-sky-400/10 mb-7 backdrop-blur-sm">
              ...
              <span className="text-xs font-medium text-sky-100/95 tracking-wide">
                Now live — secure autonomous infrastructure
              </span>
            </div>
            ...
            <p className="text-fluid-p text-slate-300 mb-9 max-w-xl leading-relaxed">
              Agent Republic gives teams a shared control plane for agents, traces, and safeguards—so you
              can ship production workflows without fragile glue code.
            </p>
            ...
            <div className="flex items-center gap-8 mt-12 pt-8 border-t border-slate-300/15">
              <div>
